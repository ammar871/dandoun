...
readToken() async {
  ...
  try {
    ...
    String? id= await storage.read(key: "packageId");
    currentUser.packageId=int.parse(id!);
...
saveToken() {
  ...
  storage.write(key: 'fullName', value: currentUser.fullName);
  storage.write(key: 'packageId', value: currentUser.packageId.toString());
